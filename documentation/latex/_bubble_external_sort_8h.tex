...
\begin{DoxyCompactList}\small\item\em Класс внешней многофазной сортировки слиянием, использующий внутреннюю пузырьковую сортировку. \end{DoxyCompactList}\end{DoxyCompactItemize}
